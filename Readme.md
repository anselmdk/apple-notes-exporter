...
```shell
git clone https://github.com/anselmdk/apple-notes-exporter
git checkout adjustments
cd apple-notes-exporter
```

2. Install `Export Notes` Shortcut using [Link](https://www.icloud.com/shortcuts/dceec2b8849b4f61ae749e1a9cab9d60) or `open "Export Notes.shortcut"` file
